      ...
      <div className="image-latin-common-container">
        ...
        <div className="latin-common-edibility-taxonomy">
          <div className="taxonomy-edibility-lookalike-psychoactive">
           ...
           <div className="info">
        <p> <strong>Edibility: </strong> {mushroom.edibility || "not provided"} </p>
        <p> <strong>Lookalike: </strong> {lookAlikesValue }</p>
        <p> <strong>Psychoactive: </strong> {mushroom.psychoactive === null ? "not provided" : mushroom.psychoactive ? "true" : "false"} </p>
            </div>
          </div>
